...
icews <- read_csv("icews_missing.csv")
...
ggplot(reb.ym,aes(x=ym,y=na.either/tot.events*100)) + geom_line() + xlab("Date") + ylab("% Missing") + ggtitle("1+ Actor Name Missing") + ylim(0,80)
...
```{r reb.map1, fig.width=7.5, cache=TRUE}
library(countrycode)
