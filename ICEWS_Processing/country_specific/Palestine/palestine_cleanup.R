...
icews <- read.csv("~/Dissertation Data/networkcreation/icews_groups.csv", stringsAsFactors = FALSE)
...
write.csv(group.months, "~/Dissertation Data/networkcreation/Network_Creation/nodes/palestine_nodes.csv")
...
#write
write_csv(pal.diss,"~/Dissertation Data/networkcreation/Network_Creation/edges/palestine_edge_events.csv")
